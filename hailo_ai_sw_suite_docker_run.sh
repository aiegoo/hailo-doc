...
readonly CONTAINER_NAME="hailo_ai_sw_suite_2024-10_container"
readonly XAUTH_FILE=/tmp/hailo_docker.xauth
readonly DOCKER_TAR_FILE="hailo_ai_sw_suite_2024-10.tar.gz"
readonly DOCKER_IMAGE_NAME="hailo_ai_sw_suite_2024-10:1"
